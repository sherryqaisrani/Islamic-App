...
public class Surahas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surahas);
        ...
        textView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(Surahas.this, Conecting.class);
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(Surahas.this, Conecting.class);
                Bundle bundle=new Bundle();
        ...
        textView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i1=new Intent(Surahas.this, Conecting.class);
                Bundle bundle=new Bundle();
        ...
        textView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i2= new Intent(Surahas.this, Conecting.class);
                Bundle bundle=new Bundle();
        ...
        textView5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i3= new Intent(Surahas.this, Conecting.class);
                Bundle bundle=new Bundle();
        ...
        textView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i4= new Intent(Surahas.this, Conecting.class);
                Bundle bundle=new Bundle();
